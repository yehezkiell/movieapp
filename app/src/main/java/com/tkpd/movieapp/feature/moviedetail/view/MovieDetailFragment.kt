...
class MovieDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.composeViewErrorState.apply {
    ...
    @Composable
    fun ErrorContent(viewModel: MovieDetailViewModel) {
        val isShowing by viewModel.showError.collectAsState()
    ...
    @Composable
    private fun ProgressBar(viewModel: MovieDetailViewModel) {
